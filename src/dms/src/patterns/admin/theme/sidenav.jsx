const sidenav = (opts={}) =>  {
  ...
  let sizes = {
    ...
    compact: {
      ...
      wrapper: "w-44",
      itemWrapper: 'pt-5',
      sideItem: "group flex px-3 py-1.5 text-[14px] font-light hover:bg-blue-100 rounded text-slate-700 mx-2 ",
      sideItemActive: "group flex px-3 py-1.5 text-[14px] font-light hover:bg-blue-100 text-slate-700  mx-2 ", //"border-r-4 border-blue-500 ",
      topItem: "flex items-center text-sm px-4 border-r h-12",
      icon: "group w-6 mr-2 text-blue-500 ",
      iconActive: "group w-6 mr-2 text-blue-500 ",
      sideItemContent: ' transition-transform duration-300 ease-in-out flex-1',
    },
    full: {
      fixed: '',
      wrapper: "w-full",
      ...
      icon: "group w-6 mr-2 text-blue-500  ",
      iconActive: "group w-6 mr-2 text-blue-500",
      sideItemContent: ' transition-transform duration-300 ease-in-out flex-1 w-full',
    },
    mini: {
      fixed: 'ml-0 md:ml-20',
